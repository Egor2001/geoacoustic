...
# cell_arr=("LinearCell" "ZCube4Cell" "VectorCell" "ZC4VecCell")
# rank_arr=(6 4 5 3) # TODO: to test Linear and ZCube4 cells

cell_arr=("VectorCell" "ZC4VecCell")
rank_arr=(4 2) # TODO: to test Linear and ZCube4 cells
