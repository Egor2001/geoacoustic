#ifndef GEOACOUSTIC_STATIC_X86_AVX256_CELL_HPP_
#define GEOACOUSTIC_STATIC_X86_AVX256_CELL_HPP_
...
#define AT_(AMPL, X, Y, Z) \
    ...
    const __m256d fdc_1 = _mm256_set1_pd(-2.0);
    const __m256d fdc_2 = _mm256_set1_pd(1.0);
...
#endif // GEOACOUSTIC_STATIC_X86_AVX256_CELL_HPP_
