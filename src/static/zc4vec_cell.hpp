...
void zc4vec_cell_simplified_proc(int3_t idx3, 
        const SimplifiedConfig<ZC4VecCell>& cfg,
        VolumeSpan<ZC4VecCell> ampl_next, VolumeSpan<ZC4VecCell> ampl);
void zc4vec_cell_simplified_wide_proc(int3_t idx3, 
        const SimplifiedConfig<ZC4VecCell>& cfg,
        VolumeSpan<ZC4VecCell> ampl_next, VolumeSpan<ZC4VecCell> ampl);
void zc4vec_cell_proc(int3_t idx3, 
        const GeneralizedConfig<ZC4VecCell>& cfg,
        VolumeSpan<ZC4VecCell> ampl_next, VolumeSpan<ZC4VecCell> ampl);
void zc4vec_cell_test_proc(int3_t idx3, 
        const GeneralizedConfig<ZC4VecCell>& cfg,
        VolumeSpan<ZC4VecCell> ampl_next, VolumeSpan<ZC4VecCell> ampl);
...
#define PROC_STENCIL_(IDX, \
    ...
    GEO_PACKED_STENCIL_FACTOR( \
                AT_(cfg.factor.span(), 0, 0, 0)[IDX].vec, \
...
inline __attribute__((always_inline)) 
void zc4vec_cell_wide_proc(int3_t idx3, 
        const GeneralizedConfig<ZC4VecCell>& cfg,
        VolumeSpan<ZC4VecCell> ampl_next, VolumeSpan<ZC4VecCell> ampl)
{
#define AT_(AMPL, X, Y, Z) \
